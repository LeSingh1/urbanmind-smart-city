...
const METRIC_DESCRIPTIONS: Partial<Record<string, string>> = {
  ...
  env_co2_est: 'Estimated annual CO2 emissions in kilotonnes, derived from transport, energy, and industrial activity.',
...
const PLANNING_INSIGHTS: Partial<Record<string, string>> = {
  ...
  env_co2_est: 'Each transit hub added reduces CO2 by reducing car dependency across its catchment area.',
